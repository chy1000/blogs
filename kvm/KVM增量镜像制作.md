...
rm /mnt1/etc/systemd/system/multi-user.target.wants/systemd-resolved.service
rm /mnt1/etc/systemd/system/dbus-org.freedesktop.resolve1.service
rm /mnt1/etc/resolv.conf
